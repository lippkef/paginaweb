...
export const APP_CONFIG = {
  ...
  seo: {
    ...
    description:
      'MiPartido es un software para clubes de pádel y tenis: organiza torneos, pozos, partidos e inscripciones online con ranking de jugadores y comunicación desde una sola app.',
    ogDescription:
      'Software para clubes de pádel y tenis: torneos, pozos, inscripciones online, ranking y comunicación con jugadores. Más pistas ocupadas. Más torneos. Más ingresos.',
    keywords: [
      'MiPartido',
  ...
  hero: {
    badge: 'SOFTWARE PARA CLUBES DE PÁDEL Y TENIS',
    headline: 'Software de gestión de torneos y eventos',
    headlineAccent: 'para tu club deportivo',
    subtitle:
      'Organiza torneos, pozos, partidos e inscripciones online con ranking de jugadores y comunicación desde una sola app.',
    bullets: [
      { icon: 'trophy', text: 'Crea torneos y eventos en minutos' },
      { icon: 'ranking', text: 'Ranking y resultados automáticos' },
      { icon: 'whatsapp', text: 'Más ocupación de pistas en tu club' },
    ],
  },
  audience:
  ...
  guia: {
    jugadorSteps: [
      'Regístrate con el enlace o QR de tu centro (?center_id=N).',
      'Completa Mi perfil e inicia sesión.',
      'En Calendario eventos pulsa UNIRME si hay plazas.',
      'Con el cuadro generado: Ver Drop y marca el ganador de tu partido.',
    ],
    jugadorTips: [
      'Puedes retirarte solo si aún no se ha generado el drop.',
      'Consulta Historial de eventos y Soporte desde el menú.',
    ],
    organizadorSteps: [
      'Crea el evento en ADM. eventos (elige tipo y cupos).',
      'Espera inscripciones o inscríbelos desde ADM. jugadores.',
      'Pulsa Generar Drop (Editar Drop solo si no hay ganadores).',
      'Registra resultados en Resultados / Pistas hora y avisa por WhatsApp o email.',
    ],
    organizadorTips: [
      'En Torneo/Pozo/Partido el máximo debe ser múltiplo de jugadores por partido.',
      'El ranking del centro se usa como semilla al generar el drop.',
    ],
    faq: [
      {
      ...
      },
      {
        ...
        a: 'El administrador del centro asigna el rol; el registro público solo crea jugadores.',
      },
      {
        q: '¿Hay app móvil?',
        a: 'Sí: Instalar MiPartido (PWA) o Añadir a pantalla de inicio en el móvil.',
      },
    ],
  },
};
